...
public enum KeyHelper {
    ...
    PRINT_SCREEN(283), PAUSE(284), F1(290), F2(291), F3(292), F4(293),
    F5(294), F6(295), F7(296), F8(297), F9(298), F10(299), F11(300), F12(301),
    F13(302), F14(303), F15(304), F16(305), F17(306), F18(307), F19(308),
    ...
    KP_ENTER(335), KP_EQUAL(336), LEFT_SHIFT(340), LEFT_CONTROL(341),
    ...
    public boolean isPressed(long window) {
        return GLFW.glfwGetKey(window, id) == GLFW.GLFW_PRESS;
    }

    public boolean isReleased(long window) {
        return GLFW.glfwGetKey(window, id) == GLFW.GLFW_RELEASE;
    }
}
